...
#ifdef FIX_CLASS
// clang-format off
FixStyle(rob/stiefel,FixROBStiefel);
// clang-format on
#else

#ifndef LMP_FIX_ROB_STIEFEL_H
...
class FixROBStiefel : public Fix {
 public:
  FixROBStiefel(class LAMMPS *, int, char **);
 ...
 protected:
   ...
   Eigen::MatrixXd stiefel_log(Eigen::MatrixXd, Eigen::MatrixXd, double);
   Eigen::MatrixXd stiefel_exp(Eigen::MatrixXd, Eigen::MatrixXd);
   void generate_samples(Eigen::MatrixXd *, Eigen::MatrixXd, Eigen::MatrixXd *);
