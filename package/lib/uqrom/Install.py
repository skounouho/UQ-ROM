...
HELP = """
Syntax from src dir: make lib-uqrom args="-b"
                 or: make lib-uqrom args="-p /usr/include/eigen3"
...
make lib-uqrom args="-b"   # download/build in default lib/uqrom/eigen-eigen-*
make lib-uqrom args="-p /usr/include/eigen3" # use existing Eigen installation in /usr/include/eigen3
"""
...
# create link in lib/uqrom to Eigen src dir
